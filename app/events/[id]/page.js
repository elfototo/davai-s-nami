        ...
        <div className='flex flex-col justify-center w-full min-h-scree px-6 py-5 md:py-10 mx-auto lg:inset-x-0 '>
          ...
          <div className='lg:flex lg:items-start bg-[#fff] rounded-xl p-10'>
            ...
            <div className='mt-8 lg:px-10 lg:mt-0'>
              ...
              <div className='mx-1 mb-5 p-5 bg-[#f4f4f9] rounded-2xl w-full lg:w-[300px]'>
                <div className='flex items-center'>
                  <IoMdPricetags size={19} color='#333' className='mb-[4px]' />
                  <p className='font-roboto text-[#333] text-gray-[#333] mb-1 lg:w-72 ml-2'>{event.price} ₽</p>
                </div>
                <div className='flex items-center'>
                  <MdCalendarMonth size={19} color='#333' />
                  <p className='font-roboto text-[#333] text-gray-[#333] my-1 lg:w-72 ml-2'>{event.date ? event.date : 'Скоро будет дата'}</p>
                </div>
                <div className='flex items-center'>
                ...
                <div className='flex items-center'>
                  <MdPlace size={19} color='#333' className='mt-1' />
                  <p className='font-roboto text-[#333] mt-1 lg:w-72 ml-2 underline hover:text-[#F52D85] cursor-pointer'>{event.place}</p>
                </div>
              </div>
              <div className='flex mb-5 flex-wrap'>
                <div className='border-[#F52D85] border px-4 py-2 rounded-xl text-[#333] hover:bg-[#F52D85] hover:text-white my-1 mx-1 transform transition-colors duration-300 cursor-pointer'>{event.category}</div>
              </div>
